...
A ChatBot can share a link to a [quick start](/extensions/quick-starts) that will help users complete a given task. Users can select **start** to initiate the linked quick start.
