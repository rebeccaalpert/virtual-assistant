...
import { Popper, useOUIAProps, OUIAProps } from '@patternfly/react-core/helpers';
...
export interface DropdownProps extends MenuProps, OUIAProps {
  ...
  className?: string;
  /** Distance between the popper and the trigger */
  distance?: number;
...
const DropdownBase: React.FunctionComponent<DropdownProps> = ({
  ...
  const ouiaProps = useOUIAProps(Dropdown.displayName ?? 'Dropdown', ouiaId, ouiaSafe);
